...
var VideoPlayer = function () {
  ...
  function VideoPlayer() {
    ...
    this.DEFAULT_COMPONENTS = ['PlayButton', 'PauseButton', 'MuteButton', 'FullscreenButton', 'VolumeButton', 'TimelineProgressbar', 'SourceCollection'];
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function initializePlayerOptions(options) {
      ...
      Object.keys(options.components).forEach(function (componentName) {
        var modelsFabric = new ModelsFabric(),
        ...
        try {
          for (var _iterator2 = Object.entries(optionsModel)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var SourceCollection = function (_Component) {
  _inherits(SourceCollection, _Component);
  ...
  function SourceCollection(videoPlayer) {
    _classCallCheck(this, SourceCollection);

    var _this = _possibleConstructorReturn(this, (SourceCollection.__proto__ || Object.getPrototypeOf(SourceCollection)).call(this));
  ...
  _createClass(SourceCollection, [{
    key: 'buildModelsCollection',
    value: function buildModelsCollection(array) {
...
var SourceModel = function (_BaseModel) {
  ...
  _createClass(SourceModel, [{
    ...
    value: function fromObject() {
      ...
      if (optionsObject.index) this.index = parseInt(optionsObject.index);
